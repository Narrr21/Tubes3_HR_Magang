...
"   ")
        ...
        self.lblApplicantName.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -517, 768, 971))
        ...
        self.listSkill = QtWidgets.QListWidget(self.groupSkills)
        self.listSkill.setObjectName("listSkill")
        self.skillsVLayout.addWidget(self.listSkill)
        ...
        self.listExperience = QtWidgets.QListWidget(self.groupWorkExperience)
        self.listExperience.setObjectName("listExperience")
        self.workExperienceVLayout.addWidget(self.listExperience)
        ...
        self.listEducation = QtWidgets.QListWidget(self.groupEducation)
        self.listEducation.setObjectName("listEducation")
        self.educationVLayout.addWidget(self.listEducation)
