...
"   ")
        ...
        self.listSkill = QtWidgets.QListView(self.groupSkills)
        ...
        self.listExperience = QtWidgets.QListView(self.groupWorkExperience)
        ...
        self.listEducation = QtWidgets.QListView(self.groupEducation)
